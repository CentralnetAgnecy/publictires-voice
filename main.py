#!/usr/bin/env python3
"""PublicTires Voice Agent - Minimal Flask App"""
...
def handle_key():
    ...
    if digit == "1":
        response.say("Pneus neufs et usagés disponibles.", language="fr-FR", voice="woman")
    elif digit == "2":
        response.say("Installation à notre centre PneusPJ.", language="fr-FR", voice="woman")
    else:
